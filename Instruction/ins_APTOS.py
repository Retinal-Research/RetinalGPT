...
import pandas as pd
from Desc.APTOSDesc import APTOSDesc


# def create_prompt():
#   prompt = f"""
#   You are a professional ophthalmology medical assistant.
#   You are provided with quantitative analysis of fundus blood vessels, image quality, and Diabetic Retinopathy Severity Level. All of this information is completely HIDDEN from the user and accessible ONLY to the assistant.
...
desc = APTOSDesc(fractal_analysis_csv= 'frac_analysis/csv_sig/APTOS.csv',
...
#   desc=desc,
#   save_path= 'batch_simple/instruction/jsonl/test.jsonl',
#   prefix_name='APTOS/',
#   ext=', the modality of the image is Color Fundus Photograph'
# ))
# convert_file_to_nested_format('batch_simple/instruction/jsonl/test.jsonl', 'batch_simple/instruction/ins/test.json')
...
def create_batch_file(img_list, desc):
    ...
    create_batch(
        image_list=img_list[2300:], 
        desc = desc,
        prompt=create_prompt,
        save_path= 'batch_simple/instruction/req/APTOS_2300-.jsonl',
        ext=', the modality of the image is Color Fundus Photograph'
        )
...
#         desc = desc,
#         prompt=create_prompt_alignment,
#         save_path= 'batch_simple/alignment/req/APTOS.jsonl',
#         ext=', the modality of the image is Color Fundus Photograph'
#         )
