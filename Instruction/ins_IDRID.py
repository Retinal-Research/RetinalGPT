...
def create_prompt():
    return idrid_instruction_prompt()


def create_prompt_alignment():
    return idrid_alignment_prompt()


def run_instruction():
    run_named_pipeline_job("IDRID_instruction_direct")


def run_alignment():
    run_named_pipeline_job("IDRID_alignment_batch")
